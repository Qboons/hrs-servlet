        ...
        <div id="container">
           ...
           <div id="middle">
                            ...
                            <div class="box">
                                ...
                                <div class="box2">
                                  <a href=/hr/sec/empadd> <button type="button">Add</button></a><br/>
                                  <a href=/hr/sec/empdel> <button type="button">Delete</button></a><br/>
                                  <a href=/hr/sec/empup>  <button type="button">Update</button></a><br/>

    ...
    <body>
		<div id="container">
		 ...
		 <div id="bar">
				...
				<div class="box">
					<form name="upForm" method="post" action="jobup">
					<table>
					<tr>
						 <%
						 try{
						...
						<td>
						   ...
						   <%  while(resultset.next()){ %>
							   <option value='<%= resultset.getString("Job_Id")%>'><%= resultset.getString("Job_id")%>;
						...
						<tr>
							<td>Max Salary:</td>
							<td><input type="number" step="0.01" name="MaxSalary"/></td>
						</tr>
						<tr>
							<td>Min Salary:</td>
							<td><input type="number" step="0.01" name="MinSalary"/></td>
						</tr>
